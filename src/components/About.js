...
export default function About() {
    ...
    return (
        <>
            <div className="container my-3" id="accordionExample" style={mystyle}>
                <h2>About Us</h2>
                ...
                <div className="container">
                    <button type="button" onClick={toggleStyle} className="btn btn-dark my-3">{btnTxt.text}</button>
                </div>
            </div>
        </>
    )
